...
def positive_assert(first_name):
    ...
    #print("Respuesta completa:", str_user)
    #print("Token generado:", user_response.json()["authToken"])
...
# Test 1. Creation of a new user
# The "firstName" parameter contains 2 characters
def test_create_user_2_letter_in_first_name_get_success_response1():
    positive_assert("Aa")

# Test 2. Creation of a new user
# The "firstName" parameter contains 15 characters
def test_create_user_15_letter_in_first_name_get_success_response2():
    positive_assert("Aaaaaaaaaaaaaaa")

# Test 3. Creation of a new user (error)
# The "firstName" parameter contains 1 character
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("A")

# Test 4. Creation of a new user (error)
# The "firstName" parameter contains 16 characters
def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("Aaaaaaaaaaaaaaaa")

# Test 5. Creation of a new user (error)
# The "firstName" parameter contain space
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("A Aaa")

# Test 6. Creation of a new user (error)
# The "firstName" parameter contain special symbols
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"N°%@\",")

# Test 7. Creation of a new user (error)
# The "firstName" parameter contain numbers
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("123")

# Test 8. Error
# The request does not contain the parameter "firstName"
